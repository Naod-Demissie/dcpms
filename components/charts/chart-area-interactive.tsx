  ...
  return (
    <Card className="@container/card">
      ...
      <CardContent className="px-2 pt-4 sm:px-6 sm:pt-6">
        <ChartContainer
          config={
            config as unknown as import("@/components/ui/chart").ChartConfig
          }
          ...
          <AreaChart data={filteredData}>
            <defs>
              ...
              <linearGradient id="fillPending" x1="0" y1="0" x2="0" y2="1">
                <stop
                  offset="5%"
                  stopColor={config.pending.color}
                  stopOpacity={0.8}
                />
                <stop
                  offset="95%"
            ...
            <Area
              ...
              stroke={config.pending.color}
              stackId="a"
              name={config.pending.label}
            />
            <Area
              dataKey="total"
              type="linear"
