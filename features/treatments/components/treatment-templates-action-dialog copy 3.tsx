...
import { createTreatmentTemplate, updateTreatmentTemplate } from "@/server/treatment-templates";
...
const formSchema = z.object({
  ...
  durationMinutes: z.coerce.number().min(0, { message: "Duration must be a positive number." }).optional(),
  isEdit: z.boolean(),
});
